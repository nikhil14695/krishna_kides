...
const modules = import.meta.glob("../assets/studio_photos/*.{webp,jpg,png}", {
  eager: true,
  import: "default",
});
    ...
    >
      ...
      <div className="absolute inset-0 bg-black/50 z-10" />
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none"
            style={{ zIndex: 9999 }}>
        <img
            src={images[12]} // Assuming index 12 is the correct index for "Kides logo copy (2).png"
